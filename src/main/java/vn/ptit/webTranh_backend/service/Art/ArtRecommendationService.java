...
import vn.ptit.webTranh_backend.dao.CartItemRepository;
import vn.ptit.webTranh_backend.dao.FavoriteArtRepository;
import vn.ptit.webTranh_backend.dao.OrderDetailRepository;
...
public class ArtRecommendationService {
    ...
    public Art generateUserProfile(int userId) {
        ...
        // Lặp qua tất cả các tranh người dùng đã tương tác
    ...
    // Phương thức phụ để lấy tất cả các bức tranh mà người dùng đã tương tác (yêu thích, giỏ hàng, đã mua)
